...
let ChatPage = class ChatPage {
    constructor(chatService, router, _firestore, product) {
...
ChatPage.propDecorators = {
    content: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonContent,] }]
};
