...
let AddItemComponent = class AddItemComponent {
    constructor(firebaseUploadService, router, _firestore, ionicAuthService, afs, modalController, alertController) {
    ...
    initForm() {
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormGroup({
            ...
            price: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required] }),
            category: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required] }),
            description: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required] }), // added email validator also
        });
    }
    changeType() {
        this.type = !this.type;
    ...
    uploadStoreDetails(formValue) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            let dataRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__.doc)(this._firestore, `stores/${(this.uid)}/items/${(pushKey)}`);
            ...
            dataRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__.doc)(this._firestore, `idOwner/${(pushKey)}`);
            yield (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__.setDoc)(dataRef, {
                owner: this.uid,
            });
...
AddItemComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
let EditItemComponent = class EditItemComponent {
    ...
    edit(id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.afs.collection(`stores/${(this.uid)}/categories/`).doc(this.form.value.category).update({
                [id]: 1,
...
EditItemComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
